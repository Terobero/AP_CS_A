...
public class SortDriver
{
    ...
    public static void main(String args[])
    {
        ...
        // MODIFY THE FOLLOWING TO GET THE NUMBER OF TRIALS AND LOOP      
            ...
            sdsqrt += sai.getTotalComparisons() * sai.getTotalComparisons();
            sd2 += sai.getTotalComparisons();
        ...
        // ADD CODE TO REPORT THE NUMBER OF COMPARISONS
            ...
            System.out.println("Min Comparisons: " + sai.getMinComparisons());
            System.out.println("Max Comparisons: " + sai.getMaxComparisons());
            System.out.println("Average Comparisons: " + sai.getTotalComparisons() / trials);
            System.out.println("Standard Deviation: " + Math.sqrt((sdsqrt/3 - (sd2/3)*(sd2/3))));
